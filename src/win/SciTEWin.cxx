...
void SciTEWin::Register(HINSTANCE hInstance_) noexcept {
	...
	wndclass.hCursor = {};
	wndclass.hbrBackground = BG_BRUSH_DARK; // makes toolbar background dark
	...
	//wndclass.hbrBackground = BRUSH_YELLOW; // TEST
	if (!::RegisterClass(&wndclass))
		exit(FALSE);
}
...
//			currentAppearance.dark = true;// val == 0;
//		}
//	}
//
//	HIGHCONTRAST info{};
...
void SciTEWin::CreateUI() {
	...
	SetWindowTheme(HwndOf(wSciTE), L"DarkMode_Explorer", NULL);
...
LRESULT SciTEWin::WndProc(UINT iMessage, WPARAM wParam, LPARAM lParam) {
	try {
		...
		case WM_UAHDRAWMENUITEM:
		{
			...
			SetTextColor(pUDMI->um.hdc, TEXT_COLOR_DARK);
