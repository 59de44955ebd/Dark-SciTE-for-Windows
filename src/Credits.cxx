...
void SciTEBase::SetAboutMessage(GUI::ScintillaWindow &wsci, const char *appTitle) {
	if (wsci.Created()) {
        ...
        // for dark
        wsci.SetMarginWidthN(1, 0);
        wsci.SetMarginLeft(10);
        wsci.SetMarginRight(10);
        // remove WS_HSCROLL
        ...
        wsci.StyleSetBack(StyleDefault, ColourRGB(0x3e, 0x3e, 0x3e)); // ColourRGB(0xff, 0xff, 0xff));
		wsci.StyleClearAll();
		...
		AddStyledText(wsci, "\n", 0);
		SetAboutStyle(wsci, 1, ColourRGB(255, 255, 255)); // 0, 0, 0
		...
		SetAboutStyle(wsci, trsSty, ColourRGB(255, 255, 255)); // 0, 0, 0
